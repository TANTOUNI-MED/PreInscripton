<?php
require_once("listAdmisClass.php");
        ...
        <div class="main_contentH">
            ...
            ?>
                <div class="main_contentV">
                    ...
                    <?php
                      $list=new ListAdmis();
                      if(isset($_POST["submitNbEtud"]) && $_POST["id_dept"]==$line["id_dept"]){
                          $list->lister($line["id_dept"],$_POST["nbEtud"]);
                      }
                    
                    if($list->findDeptIfexist($line["id_dept"])==0){ ?>
                        <form method="post" action="#" style="width: 30% ;" class="filiere-ajout">
                            <input type="hidden" name="id_dept" value="<?php echo $line["id_dept"]; ?>">
                            <input type="number" name="nbEtud" placeholder="Nombre des Etudiants admi a cette filiere">
                            <button type="submit" name="submitNbEtud" >lister</button>
                        </form>
                    <?php }else{?>
                        <h2>liste des admis au filiere <?php echo $line["filiere"] ?></h2>
                        <?php }?>
                    </div>
                    ...
                    <table>
                        ...
                        <?php 
                        $rep2 = $list->showListAdmiByDept($line["id_dept"]);
